const openModal = (triggerSelector, modalDataSelector) => { // объявляем функцию открытия модального окна, которая принимает в качестве параметров селекторы кнопки и соответствующего модального окна
  ...
  openModal('.buttons__button_five', '.modal[data-modal="five"]') 
  openModal('.buttons__button_six', '.modal[data-modal="six"]') 
  openModal('.buttons__button_seven', '.modal[data-modal="seven"]') 
  openModal('.buttons__button_eight', '.modal[data-modal="eight"]') 
